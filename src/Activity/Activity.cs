...
namespace Halso_Hub
{
    ...
    public class Activity
    {
        ...
        public List<string> CuresMoods { get; private set; }
        ...
        public Activity(string name, string description, int points, int time, List<string> curesMoods)
        {
            Name = name;
            Description = description;
            Points = points;
            Time = time;
            CuresMoods = (curesMoods == null) ? new List<string>() : curesMoods;
        }
    }
}